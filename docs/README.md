...
Índice del andamiaje SDD. El producto se describe en el [README raíz](../README.md).

| Documento | Para qué |
| --- | --- |
| [constitution.md](constitution.md) | Principios verificables. Manda sobre hábitos del agente. |
...
Agentes: [`../AGENTS.md`](../AGENTS.md). Skill: [`../.cursor/skills/sdd/SKILL.md`](../.cursor/skills/sdd/SKILL.md).
